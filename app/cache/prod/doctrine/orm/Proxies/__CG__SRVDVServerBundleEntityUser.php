 ...
 */
class User extends \SRVDV\ServerBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     * {@inheritDoc}
     */
    public function compteFontom()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'compteFontom', array());

        return parent::compteFontom();
    }

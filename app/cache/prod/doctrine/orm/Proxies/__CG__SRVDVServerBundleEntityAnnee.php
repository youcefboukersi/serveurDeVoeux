 ...
 */
class Annee extends \SRVDV\ServerBundle\Entity\Annee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'SRVDV\\ServerBundle\\Entity\\Annee' . "\0" . 'id', '' . "\0" . 'SRVDV\\ServerBundle\\Entity\\Annee' . "\0" . 'annee', '' . "\0" . 'SRVDV\\ServerBundle\\Entity\\Annee' . "\0" . 'etat');
        }
